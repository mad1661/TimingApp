    ...
    <div className="max-w-7xl mx-auto">
      ...
      {schedule.length > 0 && (
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
          ...
          <div className="bg-nhra-card border border-nhra-border rounded-xl p-4">
            <p className="text-xs text-gray-500 uppercase tracking-wider">Total Groups/Pairs</p>
                ...
                {hasActualData && (
                  <>
                    <div className="text-right">
                      ...
                      <p className="text-xs text-white/60">groups/pairs</p>
                    </div>
                    <div className="text-right">
                ...
                {hasActualData && (
                  <>
                    <div className="text-right">
                      ...
                      <p className="text-xs text-white/60">groups/pairs/hr</p>
                    </div>
                    {downtimeMin > 0 && (
                      <div className="text-right">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-nhra-border bg-nhra-darker text-gray-400 text-xs uppercase tracking-wider">
                      ...
                      <th className="text-right p-3 w-16">Grps/Prs</th>
                      <th className="text-right p-3 w-20">Duration</th>
                      <th className="text-right p-3 pr-5 w-20">Per Grp/Pr</th>
                    </tr>
                  </thead>
                  <tbody>
                    {rows.map((row, i) => {
